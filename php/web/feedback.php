...
<div class="container">
    ...
    <form action="<?=$action?>" method="post" >
        ...
        <div class="form-group">
            <label>
                Nome
                <input type="text" class="form-control" name="name"  placeholder="Digite seu nome" value="<?=$feedback->nome?>" >
            </label>
        </div>
        <div class="form-group">
            <label>
...
>>>>>>>> 2a810a30c988d068a8fc69153cae550f6c51afe0:php/low-level-php/views/feedback/create.php
