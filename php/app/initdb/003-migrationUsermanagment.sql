...
CREATE INDEX user_id4 ON auth_assignment (user_id);
...
CREATE INDEX fk_auth_item_group_code ON auth_item (group_code);
...
CREATE SEQUENCE user_visit_log_seq;
...
ALTER SEQUENCE user_visit_log_seq RESTART WITH 1;

CREATE INDEX user_id ON user_visit_log (user_id);
